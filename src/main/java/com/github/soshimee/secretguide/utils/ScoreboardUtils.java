...
// Modified by soshimee to work in 2024.
...
public class ScoreboardUtils {
	...
	public static List<String> getSidebarScores(Scoreboard scoreboard) {
		...
		if (sidebar != null) {
			...
			found = scores.stream()
				...
				.map(score -> getPrefixFromContainingTeam(scoreboard, score.getPlayerName()) /*+ score.getPlayerName()*/ + getSuffixFromContainingTeam(scoreboard, score.getPlayerName()))
	 ...
	 * that contains the first part of our scoreboard message.
	 *
	 * @param scoreboard The target scoreboard
